...
function UserProfile({userProp}) {
  ...
  const editHandler = async () => {
    ...
    if (prev) {
      try {
        const updates = {
            fullName: name, username: displayName, bio: bio
          }
          console.log(updates)
...
//                 </div>
//                 <div className="mt-4 sm:mt-0 sm:pt-1 sm:text-left">
//                   <p className="text-xl font-bold text-gray-900 sm:text-2xl">{user.name || "Default User"}</p>
//                   <p className="text-sm font-medium text-gray-600">@{user.username || "defaultuser"}</p>
//                 </div>
//               </div>
//               <div className="mt-5 sm:mt-0">
//                 <button className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
...
//               <div className="sm:col-span-1">
//                 <dt className="text-sm font-medium text-gray-500">Email</dt>
//                 <dd className="mt-1 text-sm text-gray-900">{user.email || "default@example.com"}</dd>
//               </div>
//               <div className="sm:col-span-1">
//                 <dt className="text-sm font-medium text-gray-500">Joined</dt>
...
//               <div className="sm:col-span-2">
//                 <dt className="text-sm font-medium text-gray-500">Bio</dt>
//                 <dd className="mt-1 text-sm text-gray-900">{user.bio || "This is a default bio."}</dd>
//               </div>
//             </dl>
//           </div>
//           <div className="border-t border-gray-200 p-6 sm:p-8">
